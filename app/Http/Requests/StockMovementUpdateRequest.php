...
class StockMovementUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'movement_type' => 'sometimes|required|in:entrada,salida,ajuste,devolucion',
            'reason' => 'sometimes|required|string|max:500',
            'voucher_number' => 'sometimes|nullable|string|max:255',
            'stocks' => 'sometimes|required|array|min:1',
            'stocks.*.stock_id' => 'sometimes|required|exists:stocks,id',
            'stocks.*.quantity' => 'sometimes|required|integer|min:1',
            'stocks.*.unit_price' => 'sometimes|nullable|numeric|min:0',
        ];
    }
